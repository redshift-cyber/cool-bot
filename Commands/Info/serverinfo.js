...
module.exports = {
    ...
    .addField('Channel Counts', `\`${channelCount}\` Total Channels || $\`${textChannels}\` |\`${voiceChannels}\` | \`${newsChannels}\` | ${emoji.StoreChannel}\`${storeChannel}\``)
    .addField('User Status', `\`${online}\`  \`${afk}\`  \`${dnd}\`  \`${offline}\``)
